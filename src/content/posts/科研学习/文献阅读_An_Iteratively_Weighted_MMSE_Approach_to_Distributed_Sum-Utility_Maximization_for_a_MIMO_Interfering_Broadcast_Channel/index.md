...
description: "本文是论文《An Iteratively Weighted MMSE Approach to Distributed Sum-Utility Maximization for a MIMO Interfering Broadcast Channel》的学习笔记"
image: "./cover.png"
...
本文是论文《An Iteratively Weighted MMSE Approach to Distributed Sum-Utility Maximization for a MIMO Interfering Broadcast Channel》的学习笔记，并尝试复现了文中的算法。本文仅表达个人见解，可能会有错误，欢迎指正交流。:)
