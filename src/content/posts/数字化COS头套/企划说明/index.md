---
title: 数字化 COS 头套（P1.企划说明）
published: 2026-05-06
description: "本文记录数字化 COS 头套项目的前期企划思路，围绕外部表情屏、内部视觉系统、模块化结构、散热通风和主控选型展开。"
image: "./cover.png"
...
这个项目的起点来自我之前用 KT 板制作 MC 风格明日方舟 COS 头套的经历。当时的外观效果虽然比较直观，但是实际佩戴时暴露出了两个非常明显的问题：一是散热和通风不好，长时间佩戴会闷热；二是视野很差，行动时安全性和舒适性都不够理想，导致游玩体验会非常坐牢（真的给我累麻了）。( ╯' - ')╯ ┻━┻

![初代](初代.png)

其实还有另外一个原因是我买不起Kigurumi(╥﹏╥)，而且Kigurumi同样也会面临如上的问题。在参考了很多Kig的可视化改造方案后，这次我希望不只是再做一个静态头套，而是尝试规划一个具有屏幕表情、摄像头视野、内部显示、通风结构和模块化外壳的可迭代平台。它既要能服务于某一个角色，也要尽量形成一套通用结构，方便之后更换不同角色的外观模块。这相比Kig的优点是复用性强，可以出很多不同的角色；内部空间大，可以放置更多的优化体验的设备；同时可以与外部进行交互。
